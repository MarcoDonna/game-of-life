...
ActiveRecord::Schema[8.0].define(version: 2025_09_28_115909) do
  create_table "game_frames", force: :cascade do |t|
    t.integer "game_id", null: false
    t.integer "prev_frame_id"
    t.integer "next_frame_id"
    t.binary "state"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["game_id"], name: "index_game_frames_on_game_id"
    t.index ["next_frame_id"], name: "index_game_frames_on_next_frame_id"
